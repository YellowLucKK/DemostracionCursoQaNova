...
public class CargaInformacion {
    ...
    public String recuperarTitulo(){
        ...
        PdfQaNovaReports.addWebReportImage("Despliegue Carga Informacion", "Carga informacion desplegado correctamente", EstadoPrueba.PASSED, false);
